// @ts-nocheck
import * as __fd_glob_12 from "../content/docs/guides/install.mdx?collection=docs"
import * as __fd_glob_11 from "../content/docs/guides/first-application.mdx?collection=docs"
